import type { AnalysisData } from "./analyze-schema";

export type OptionType = "reuse" | "donate" | "sell" | "recycle";
...
type Identified = Extract<AnalysisData, { identified: true }>;

const KIND_MATCHERS: Array<{ kind: ItemKind; terms: string[] }> = [
  { kind: "battery", terms: ["battery", "lithium", "aa battery", "aaa"] },
  {
    kind: "electronics",
    terms: [
      "phone",
  ...
  {
    kind: "glass",
    terms: ["jar", "wine glass", "glass bottle", " tumbler", "vase", "glass"],
  },
  {
    kind: "kitchen",
    terms: [
  ...
  {
    kind: "paper",
    terms: ["cardboard", "box", "paper", "newspaper", "book", "magazine", "carton"],
  },
  {
    kind: "metal",
    terms: ["aluminum", "aluminium", "tin can", "steel", "iron", "metal can", "can"],
  },
  { kind: "plastic", terms: ["plastic", "tupperware", "container"] },
];

function others(
  best: OptionType,
  notes: Record<OptionType, { title: string; note: string }>,
): Identified["other_options"] {
  return (["reuse", "donate", "sell", "recycle"] as const)
    .filter((type) => type !== best)
    .map((type) => ({ type, title: notes[type].title, note: notes[type].note }));
}

export function kindFromCaption(caption: string): ItemKind | null {
  const normalized = caption.toLowerCase();
  const match = KIND_MATCHERS.find((candidate) =>
...
export function recommendFromKind(
  ...
  const repair = condition === "needs_repair";
  ...
  switch (kind) {
    case "battery":
      return {
        ...
        best_option: "recycle",
        reason:
          "Used batteries belong at a dedicated collection point, not in household waste.",
        condition_check: {
          question: "Is the battery intact, with no leaking, swelling, heat, or puncture?",
          if_good:
            "Take it to a battery or household-hazardous-waste collection point without opening it.",
          if_bad:
        ...
        other_options: others("recycle", {
          reuse: {
            title: "Do not reuse damaged cells",
            note: "Recharging or prying open a used cell is unsafe.",
          },
          donate: {
            title: "Do not donate used cells",
            note: "Charity shops cannot take loose or used batteries.",
          },
          sell: {
            title: "Do not sell used cells",
            note: "Used lithium cells are a fire risk in transit.",
          },
          recycle: {
            title: "Recycle at a collection point",
            note: "Use a battery drop-off, not ordinary recycling.",
          },
        }),
        creative_ideas: [
    ...
    case "electronics":
      return {
        ...
        condition_check: {
          question:
            "Does it power on without a damaged cable, swelling, heat, or a burning smell?",
          if_good: "Keep using it, or pass it to someone who needs that device.",
          if_bad:
            "Stop using it. Use an electronics or battery collection point instead of ordinary waste.",
        },
        steps: [
        ...
        other_options: others(broken ? "recycle" : "reuse", {
          reuse: {
            ...
            note: "Only if it powers on safely and has no swollen battery.",
          },
          donate: {
            title: "Give it to a reuse programme",
            note: "Some community centres accept working phones, laptops, or cables.",
          },
          sell: {
            title: "Sell a working device",
            note: "Wipe it first. Do not sell a device with a damaged battery.",
          },
          recycle: {
            title: "Use an e-waste point",
            note: "Retail take-back and civic amenity sites accept mixed electronics.",
          },
        }),
        creative_ideas: [
    ...
    case "clothing":
      return {
        ...
        condition_check: {
          ...
          if_bad:
            "Do not donate soiled textiles. Use a textile recycling bank if the fabric is dry.",
        },
        steps: [
        ...
        other_options: others(broken ? "recycle" : "donate", {
          reuse: {
            title: "Keep wearing or mending it",
            note: "A simple repair often extends the life of a garment.",
          },
          donate: {
            title: "Pass it to a textile programme",
            note: "Charity shops and textile banks want clean, dry clothing.",
          },
          sell: {
            title: "Sell if it is in demand",
            note: "Resale only makes sense if it is clean, wearable, and wanted.",
          },
          recycle: {
            title: "Use a textile bank",
            note: "Fibre recycling is the next step when it cannot be worn.",
          },
        }),
        creative_ideas: [
    ...
    case "furniture":
      return {
        ...
        condition_check: {
          question:
            "Is the frame sound, with no wobble, broken joints, mould, or pest damage?",
          if_good: "Keep it, or offer it to a furniture bank or community centre.",
          if_bad:
            "Do not let someone sit or sleep on it. Salvage sound parts or use bulky-waste recycling.",
        },
        steps: [
          "Test joints, legs, and any moving parts by hand.",
          "Wipe dust and look for mould or sharp hardware.",
          broken
            ? "Do not donate a structurally unsafe piece."
            : "If it is sound, keep it or list it for a furniture bank.",
          "For disposal, use bulky-item collection rather than a household bin.",
        ],
        other_options: others(broken ? "recycle" : "reuse", {
          reuse: {
            title: "Keep it in the home",
            note: "A tighten-up or new hardware can make a sound piece last.",
          },
          donate: {
            title: "Offer it to a furniture bank",
            note: "Furniture banks and community centres want clean, sturdy pieces.",
          },
          sell: {
            title: "Sell a sound piece",
            note: "Local listing works when the item is clean and structurally sound.",
          },
          recycle: {
            title: "Use bulky-waste recycling",
            note: "Wood, metal, and fabric can often be separated at a civic amenity site.",
          },
        }),
        creative_ideas: [
    ...
    case "glass":
      return {
        ...
        best_option: broken ? "recycle" : "reuse",
        reason: broken
          ? "Broken glass should go in glass recycling if your service accepts it, not the general bin when avoidable."
          : "A sound jar or bottle is one of the easiest things to keep in daily use.",
        condition_check: {
          question:
            "Is it free from cracks, and was it only used for food that you can wash out completely?",
          if_good: "Wash it and keep it for storage, or recycle clean glass.",
          if_bad:
            "Do not store food in a cracked or chemically stained container. Recycle the glass if accepted.",
        },
        steps: [
        ...
        other_options: others(broken ? "recycle" : "reuse", {
          reuse: {
            title: "Keep it as storage",
            note: "Jars work for dry food, hardware, or leftover cooking.",
          },
          donate: {
            title: "Pass clean jars on",
            note: "Some community kitchens and schools welcome clean jars.",
          },
          sell: {
            title: "Sell only unusual pieces",
            note: "Ordinary jars rarely sell; a distinctive bottle might.",
          },
          recycle: {
            title: "Use glass recycling",
            note: "Rinse it first. Do not bag glass unless your service asks you to.",
          },
        }),
        creative_ideas: [
    ...
    case "kitchen":
      return {
        ...
        condition_check: {
          question:
            "Is it free from rust-through, loose handles, deep non-stick flakes, or cracks that touch food?",
          if_good: "Wash it and keep using it, or pass it to a community kitchen.",
          if_bad:
            "Stop cooking with it. Recycle metal bodies; ceramics with food-safe cracks still go to residual waste in many areas.",
        },
        steps: [
          "Look at handles, rims, and any non-stick surface.",
          "Wash it if you plan to keep or donate it.",
          broken
            ? "Do not donate unsafe cookware."
            : "Keep it, or offer sound items to a community kitchen.",
          "Metal pans can often go to scrap metal at a civic amenity site.",
        ],
        other_options: others(broken ? "recycle" : "reuse", {
          reuse: {
            title: "Keep it in the kitchen",
            note: "Everyday pots, plates, and utensils are built to last.",
          },
          donate: {
            title: "Give it to a community kitchen",
            note: "Community centres and shelters often need sound cookware.",
          },
          sell: {
            title: "Sell distinctive pieces",
            note: "Cast iron and complete sets sometimes sell locally.",
          },
          recycle: {
            title: "Recycle the metal body",
            note: "Remove loose plastic handles if you can do so safely.",
          },
        }),
        creative_ideas: [
    ...
    case "paper":
      return {
        ...
        best_option: "recycle",
        reason:
          "Clean paper and cardboard belong in the paper stream once they have no further use at home.",
        condition_check: {
          ...
          if_bad:
            "Greasy or lined packaging often cannot be recycled. Use residual waste if your service rejects it.",
        },
        steps: [
        ...
        other_options: others("recycle", {
          reuse: {
            title: "Reuse a sturdy box",
            note: "Storage, moving, and posting still need sound cardboard.",
          },
          donate: {
            title: "Offer packing boxes",
            note: "Schools and community centres sometimes want clean boxes.",
          },
          sell: {
            title: "Selling is rarely worth it",
            note: "Ordinary cardboard has little resale value.",
          },
          recycle: {
            title: "Use paper recycling",
            note: "Clean, dry fibre is straightforward to recycle.",
          },
        }),
        creative_ideas: [
    ...
    case "metal":
      return {
        ...
        condition_check: {
          ...
          if_bad:
            "Protect sharp edges. Recycle clean scrap; do not crush aerosol cans that still hold pressure.",
        },
        steps: [
        ...
        other_options: others(broken ? "recycle" : "reuse", {
          reuse: {
            title: "Keep a sound piece",
            note: "Tins and trays can store hardware or dry goods.",
          },
          donate: {
            title: "Donate useful metalware",
            note: "Sound tools and tins sometimes help a community workshop.",
          },
          sell: {
            title: "Sell tools or larger scrap",
            note: "Hand tools and large metal pieces can have local value.",
          },
          recycle: {
            title: "Use metal recycling",
            note: "Most councils accept steel and aluminium at the kerb or tip.",
          },
        }),
        creative_ideas: [
        ...
        warning:
          "Do not puncture pressurised cans. Paint and chemical tins need a household-hazardous-waste site.",
      };
    ...
    case "plastic":
      return {
        ...
        condition_check: {
          question:
            "Is it clean, uncracked, and marked with a resin code your service accepts?",
          if_good: "Keep using it for dry storage, or rinse it for recycling.",
          if_bad:
            "Cracked food containers should not hold food. Recycle only if the type is accepted locally.",
        },
        steps: [
          "Read the recycling mark on the base.",
          "Rinse food residue; lids may belong in a different stream.",
          broken
            ? "Recycle only the types your collection actually takes."
            : "Reuse sound tubs before you recycle them.",
          "Soft film usually needs a supermarket collection, not the kerb bin.",
        ],
        other_options: others(broken ? "recycle" : "reuse", {
          reuse: {
            title: "Keep it for storage",
            note: "Sound tubs are useful for food, hardware, or leftovers.",
          },
          donate: {
            title: "Pass on unused storage",
            note: "Community kitchens sometimes want clean, lidded tubs.",
          },
          sell: {
            title: "Sell only unused sets",
            note: "Used everyday plastic rarely sells.",
          },
          recycle: {
            title: "Follow the local plastic rules",
            note: "Acceptance varies widely by resin type and council.",
          },
        }),
        creative_ideas: [
    ...
    default:
      return {
        ...
        condition_check: {
          question:
            "Can you tell what it is made of, and is it safe to handle with no chemical smell or sharp damage?",
          if_good: "Keep using it, or pass it to someone who needs that kind of object.",
          if_bad:
            "Do not guess with chemicals, batteries, or sharp waste. Use the correct drop-off.",
        },
        steps: [
          "Identify the main material if you can.",
          "Set aside anything that looks like a battery, chemical, or medicine.",
          broken
            ? "Recycle only the parts your local service accepts."
            : "Keep it if it is safe, or offer it to a charity shop.",
          "When unsure, ask your council’s waste guide before you bin it.",
        ],
        other_options: others(broken ? "recycle" : "reuse", {
          reuse: {
            title: "Keep it if it is safe",
            note: "A second use at home beats a trip to the bin.",
          },
          donate: {
            title: "Offer it to a charity shop",
            note: "Only if it is clean, complete, and something they can sell.",
          },
          sell: {
            title: "Sell if someone would pay",
            note: "Local listing works for complete, working household goods.",
          },
          recycle: {
            title: "Match the material to a stream",
            note: "Mixed objects often need taking apart first.",
          },
        }),
        creative_ideas: [
